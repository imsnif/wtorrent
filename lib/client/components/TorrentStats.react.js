...
let TorrentStats = React.createClass({
  ...
  render: function() {
    ...
    let uploadSpeed = Math.round(torrent.uploadSpeed / 1000) + "KBps";
    let downloadSpeed = Math.round(torrent.downloadSpeed / 1000) + "KBps";
    let ratio = (torrent.uploaded / torrent.downloaded).toFixed(2);
    return (
      <Row>
